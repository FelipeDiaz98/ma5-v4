...
bool Analysis::Initialize(const MA5::Configuration& cfg, const std::map<std::string,std::string>& parameters)
{
  ...
  Manager()->AddHisto("Efficiencies", 6, 0.0, 7.0);
  plot_Efficiencies = new TH1F("Efficiencies", "Efficiencies", 6, 0.0, 7.0);
  
  Manager()->AddHisto("StMet", 100, 0.0, 1000.0);
  plot_StMet = new TH1F("StMet", "StMet", 100, 0.0, 1000.0);
  
  Manager()->AddHisto("PT_Scalar_mus", 100, 0.0, 1000.0);
  plot_PT_Scalar_mus = new TH1F("PT_Scalar_mus", "PT_Scalar_mus", 100, 0.0, 1000.0);
  
  Manager()->AddHisto("PT_Vector_mus", 100, 0.0, 1000.0);
  plot_PT_Vector_mus = new TH1F("PT_Vector_mus", "PT_Vector_mus", 100, 0.0, 1000.0);
...
void Analysis::Finalize(const SampleFormat& summary, const std::vector<SampleFormat>& files)
{
  ...
  //**************************************************************************************************************************************************************************************************
  //**************************************************************************************************************************************************************************************************
  plot_Efficiencies->SetLineStyle(1);
  plot_StMet->SetLineStyle(1);
  plot_PT_Scalar_mus->SetLineStyle(1);
  plot_PT_Vector_mus->SetLineStyle(1);
  ...
  //**************************************************************************************************************************************************************************************************
  //**************************************************************************************************************************************************************************************************
  TAxis* i = plot_Efficiencies->GetXaxis();
  i->SetBit(TAxis::kLabelsHori); 
  i->SetBinLabel(1,"Cut_{0}");
  i->SetBinLabel(1,"Cut_{1}");
  i->SetBinLabel(1,"Cut_{2}");
  i->SetBinLabel(1,"Cut_{3}");
  i->SetBinLabel(1,"Cut_{4}");
  i->SetBinLabel(1,"Cut_{5}");
  plot_Efficiencies->Draw("HIST");
  
  plot_StMet->Draw("HIST");
  plot_PT_Scalar_mus->Draw("HIST");
  plot_PT_Vector_mus->Draw("HIST");
  ...
  //**************************************************************************************************************************************************************************************************
  //**************************************************************************************************************************************************************************************************
  plot_Efficiencies->Write();
  plot_StMet->Write();
  plot_PT_Scalar_mus->Write();
  plot_PT_Vector_mus->Write();
	...
	//********************************************************************************************************************************************************************************************
  	if (FinalStateJs.size() == 2){
  		...
  		for (MAuint32 i = 0; i < cuts.size(); i++){
  			if (cuts[i] == true){
				Manager()->FillHisto("Efficiencies", i + 1);
        			plot_Efficiencies->Fill(i + 1);
        		}
        	}
    		...
    		Manager()->FillHisto("StMet", total_PT);
        	plot_StMet->Fill(total_PT);
        	
        	//fills PT_Scalar_mus.
        	Manager()->FillHisto("PT_Scalar_mus", FinalStateLeptons[index_mu1]->momentum().Pt() + FinalStateLeptons[index_mu2]->momentum().Pt());
        	plot_PT_Scalar_mus->Fill(FinalStateLeptons[index_mu1]->momentum().Pt() + FinalStateLeptons[index_mu2]->momentum().Pt());
        	
        	//fills PT_Vector_mus.
        	Manager()->FillHisto("PT_Vector_mus", (FinalStateLeptons[index_mu1]->momentum() + FinalStateLeptons[index_mu2]->momentum()).Pt());
        	plot_PT_Vector_mus->Fill((FinalStateLeptons[index_mu1]->momentum() + FinalStateLeptons[index_mu2]->momentum()).Pt());
