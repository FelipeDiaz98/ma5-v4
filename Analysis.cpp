...
bool Analysis::Initialize(const MA5::Configuration& cfg, const std::map<std::string,std::string>& parameters)
{
  ...
  Manager()->AddHisto("PT_Scalar_leptons_e", 100, 0.0, 1000.0);
  plot_PT_Scalar_leptons_e = new TH1F("PT_Scalar_leptons_e", "PT_Scalar_leptons_e", 100, 0.0, 1000.0);
  
  Manager()->AddHisto("PT_Vector_leptons_e", 100, 0.0, 1000.0);
  plot_PT_Vector_leptons_e = new TH1F("PT_Vector_leptons_e", "PT_Vector_leptons_e", 100, 0.0, 1000.0);
  ...
  Manager()->AddHisto("PT_Scalar_leptons_mu", 100, 0.0, 1000.0);
  plot_PT_Scalar_leptons_mu = new TH1F("PT_Scalar_leptons_mu", "PT_Scalar_leptons_mu", 100, 0.0, 1000.0);
  
  Manager()->AddHisto("PT_Vector_leptons_mu", 100, 0.0, 1000.0);
  plot_PT_Vector_leptons_mu = new TH1F("PT_Vector_leptons_mu", "PT_Vector_leptons_mu", 100, 0.0, 1000.0);
